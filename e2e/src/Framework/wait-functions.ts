...
export class WaitFunctions {
  waitUntilAppLoaded = function () {
    browser.waitForAngular();
    browser.driver.sleep(3000);
  };

  waitUntilPaymentCreated = function () {
    browser.waitForAngular();
    browser.driver.sleep(1000);
  };

  waitUntilOrderStatusChange = function () {
    browser.waitForAngular();
    browser.driver.sleep(3000);
  };

  waitUntilModalOpen = function () {
    browser.waitForAngular();
    browser.driver.sleep(1000);
  };

  waitUntilBroswerRefresh = function () {
    browser.refresh();
    browser.waitForAngular();
    browser.driver.sleep(1000);
  };
